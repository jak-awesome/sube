...
<html lang="en">
 ...
 <!-- Form Registrasi -->
  <div class="container">
    <h3 class="text-center mt-3 mb-5">SILAHKAN EDIT</h3>
    <div class="card p-5 mb-5">
      <form method="POST" action="process/p_edit.php" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="file" class="form-control-file border" id="gambar" name="foto_produk">
        </div><br>
