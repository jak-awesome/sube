...
<head>
  ...
  <title>Tambah Data Pelanggan - CV SUBE</title>
...
?>
  ...
  ?>
        ...
        <h2>Pelanggan</h2>
        <form method="POST" action=" process/proses_tambah_pelanggan.php" enctype="multipart/form-data">
        <input type="text" name="id_pelanggan" class="form-control" value="<?php echo $kodePelanggan ?>" hidden>
          ...
          <div class="mb-3">
              ...
              <input type="submit" class="btn btn-primary" name="submit" value="Tambah Pelanggan">
          </div>
          </form>
