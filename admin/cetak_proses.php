...
<thead>
                ...
                <?php
              $no = 1;
              $tampil = mysqli_query($koneksi, "SELECT * FROM transaksi INNER JOIN pelanggan ON transaksi.id_pelanggan = pelanggan.id_pelanggan INNER JOIN produk ON transaksi.id_produk = produk.id_produk WHERE status='Dalam Proses'");
