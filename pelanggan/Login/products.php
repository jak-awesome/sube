      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
          ...
          <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
            <li data-filter="*" class="filter-active">Our Products</li><br><br>
            <a data-aos="fade-up" data-aos-delay="200" href="form_tambah_pesanan.php" class="btn btn-primary">Pesan Sekarang!</a>
          ...
          <?php foreach($data as $data) : ?>
            <div class="col-lg-4 col-md-6 portfolio-item filter-remodeling">
              <div class="portfolio-content h-100">
                <a href="../../admin/foto_produk/<?= $data['foto_produk']; ?>" title="Nama Produk : <?php echo  $data['nama_produk']; ?><br>Harga Produk : <?php echo  rupiah($data['harga_produk']); ?>" data-gallery="portfolio-gallery-remodeling" class="glightbox preview-link">
                <img src="../../admin/foto_produk/<?= $data['foto_produk']; ?>" class="img-fluid" alt="">
                </a>
              </div>
              </div>
              <?php endforeach; ?>
