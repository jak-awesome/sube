...
<head>
  ...
  <title>Tambah Pemesanan - CV SUBE</title>
  ...
  ?>
        ...
        <form method="POST" action="../process/proses_tambah_pesanan_pelanggan.php" enctype="multipart/form-data">
          ...
          <div class="mb-3">
              ...
              <input type="number" name="jumlah_pemesanan" class="form-control" placeholder="Masukan Jumlah Pesanan">
          </div>
          
          <div class="">
                <label class="form-label">Catatan</label>
              <input type="text" name="deskripsi" class="form-control" placeholder="Masukan Deskripsi Desain">
          </div>

          <div class="mb-3">
                <label class="form-label">Desain</label>
                <div>
              <input type="file" name="foto" placeholder="" accept="image/*"></div>
          </div>

    <div class="mb-3">
              <input type="submit" class="btn btn-primary" name="submit" value="Tambah Pesanan">
          </div>
          </form>
